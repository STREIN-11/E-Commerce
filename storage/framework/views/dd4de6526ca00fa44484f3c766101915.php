...
<nav class="nav">
    ...
    <div class="nav-center">
        <div class="nav-links">
            ...
            <a href="<?php echo e(route('admin.products.show', $product)); ?>" class="nav-link">👁 View</a>
        </div>
    </div>
    <div class="nav-right">
        <div class="user-menu">
...
<form method="POST" action="<?php echo e(route('admin.products.update', $product)); ?>" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <textarea id="description" name="description" rows="4" required><?php echo e(old('description', $product->description)); ?></textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" id="category" name="category" value="<?php echo e(old('category', $product->category)); ?>" required>
    </div>
    ...
    <div class="form-group">
        ...
        <small>Current image: <?php echo e($product->image); ?></small>
    </div>
    
    <button type="submit" class="btn">Update Product</button>
    <a href="<?php echo e(route('admin.products.show', $product)); ?>" class="btn" style="background: #6c757d;">Cancel</a>
</form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\subha\OneDrive\Desktop\Assesment\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>